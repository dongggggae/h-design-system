...
export { default as BadgeText } from '@components/Badge/Text';
export type { BadgeTextProps } from '@components/Badge/Text';

export { default as Btn } from '@components/Btn';
export type { ButtonProps } from '@components/Btn';
